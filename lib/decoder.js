...
class FlacStreamDecoder extends stream.Transform {
    ...
    _chunksIsAlmostEmpty() {
        if(this._lastBytesDemanded !== undefined) {
            return this._le_chunks.reduce((r, v) => r + v.length, 0) < this._lastBytesDemanded;
        } else {
            return this._le_chunks.length > 1;
        }
    }
