...
namespace flac_bindings {
    ...
    public:
        ...
        typedef std::function<IterationReturnValue(typename AsyncTask::ExecutionProgress&, uint64_t)> IteratorFunction;
        ...
        static Napi::Value newIterator(
            ...
            Function constructor = NativeAsyncIterator::DefineClass(env, "NativeAsyncIterator", {
