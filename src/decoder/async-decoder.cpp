...
namespace flac_bindings {
  ...
  AsyncDecoderWork::FunctionCallback
    AsyncDecoderWork::decorate(DecoderWorkContext* ctx, const std::function<int()>& func) {
  ...
  AsyncDecoderWork* AsyncDecoderWork::forFinish(const Object& self, DecoderWorkContext* ctx) {
    auto workFunction = [ctx]() {
      return FLAC__stream_decoder_finish(ctx->dec->dec);
    };
  ...
  AsyncDecoderWork* AsyncDecoderWork::forFlush(const Object& self, DecoderWorkContext* ctx) {
    auto workFunction = [ctx]() {
      return FLAC__stream_decoder_flush(ctx->dec->dec);
    };
    return new AsyncDecoderWork(
      self,
      workFunction,
  ...
  AsyncDecoderWork*
    AsyncDecoderWork::forProcessSingle(const Object& self, DecoderWorkContext* ctx) {
    auto workFunction = [ctx]() {
      return FLAC__stream_decoder_process_single(ctx->dec->dec);
    };
    return new AsyncDecoderWork(
      self,
      workFunction,
  ...
  AsyncDecoderWork*
    AsyncDecoderWork::forProcessUntilEndOfMetadata(const Object& self, DecoderWorkContext* ctx) {
    auto workFunction = [ctx]() {
      return FLAC__stream_decoder_process_until_end_of_metadata(ctx->dec->dec);
    };
    return new AsyncDecoderWork(
      self,
      workFunction,
  ...
  AsyncDecoderWork*
    AsyncDecoderWork::forProcessUntilEndOfStream(const Object& self, DecoderWorkContext* ctx) {
    auto workFunction = [ctx]() {
      return FLAC__stream_decoder_process_until_end_of_stream(ctx->dec->dec);
    };
    return new AsyncDecoderWork(
      self,
      workFunction,
  ...
  AsyncDecoderWork*
    AsyncDecoderWork::forSkipSingleFrame(const Object& self, DecoderWorkContext* ctx) {
    auto workFunction = [ctx]() {
      return FLAC__stream_decoder_skip_single_frame(ctx->dec->dec);
    };
    return new AsyncDecoderWork(
      self,
      workFunction,
  ...
  AsyncDecoderWork*
    AsyncDecoderWork::forSeekAbsolute(const Object& self, uint64_t value, DecoderWorkContext* ctx) {
    auto workFunction = [ctx, value]() {
      return FLAC__stream_decoder_seek_absolute(ctx->dec->dec, value);
    };
    return new AsyncDecoderWork(
      self,
      workFunction,
  ...
  AsyncDecoderWork* AsyncDecoderWork::forInitStream(const Object& self, DecoderWorkContext* ctx) {
    ...
    return new AsyncDecoderWork(
      self,
      workFunction,
      "flac_bindings::StreamDecoder::initStreamAsync",
      ctx,
      convertFunction);
  }

  AsyncDecoderWork*
    AsyncDecoderWork::forInitOggStream(const Object& self, DecoderWorkContext* ctx) {
    auto workFunction = [ctx]() {
    ...
    return new AsyncDecoderWork(
      self,
      workFunction,
      "flac_bindings::StreamDecoder::initOggStreamAsync",
      ctx,
      convertFunction);
  }
  ...
  AsyncDecoderWork* AsyncDecoderWork::forInitFile(
    ...
    return new AsyncDecoderWork(
      self,
      workFunction,
      "flac_bindings::StreamDecoder::initFileAsync",
      ctx,
      convertFunction);
  }
  ...
  AsyncDecoderWork* AsyncDecoderWork::forInitOggFile(
    ...
    return new AsyncDecoderWork(
      self,
      workFunction,
      "flac_bindings::StreamDecoder::initOggFileAsync",
      ctx,
      convertFunction);
  }
  ...
  void AsyncDecoderWork::onProgress(
    ...
    switch (req->type) {
      ...
      case DecoderWorkRequest::Type::Read: {
        ...
        processResult =
          generateParseObjectResult(req->returnValue, "Decoder:ReadCallback", "bytes", *req->bytes);
        break;
      }
