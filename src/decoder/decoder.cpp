...
namespace flac_bindings {
    ...
    Function StreamDecoder::init(const Napi::Env& env) {
        ...
        auto constructor = DefineClass(env, "StreamDecoder", {
            ...
            InstanceMethod("setMetadataRespondApplication", &StreamDecoder::setMetadataRespondApplication),
            InstanceMethod("setMetadataRespondAll", &StreamDecoder::setMetadataRespondAll),
            InstanceMethod("setMetadataIgnoreApplication", &StreamDecoder::setMetadataIgnoreApplication),
            ...
            InstanceMethod("processUntilEndOfMetadataAsync", &StreamDecoder::processUntilEndOfMetadataAsync),
            InstanceMethod("processUntilEndOfStreamAsync", &StreamDecoder::processUntilEndOfStreamAsync),
    ...
    Napi::Value StreamDecoder::processSingleAsync(const CallbackInfo& info) {
        ...
        AsyncDecoderWork* work = AsyncDecoderWork::forProcessSingle(info.This().As<Object>(), ctx.get());
        return enqueueWork(work);
    }
    ...
    Napi::Value StreamDecoder::processUntilEndOfMetadataAsync(const CallbackInfo& info) {
        ...
        AsyncDecoderWork* work = AsyncDecoderWork::forProcessUntilEndOfMetadata(info.This().As<Object>(), ctx.get());
        return enqueueWork(work);
    }
    ...
    Napi::Value StreamDecoder::processUntilEndOfStreamAsync(const CallbackInfo& info) {
        ...
        AsyncDecoderWork* work = AsyncDecoderWork::forProcessUntilEndOfStream(info.This().As<Object>(), ctx.get());
        return enqueueWork(work);
    }
    ...
    Napi::Value StreamDecoder::skipSingleFrameAsync(const CallbackInfo& info) {
        ...
        AsyncDecoderWork* work = AsyncDecoderWork::forSkipSingleFrame(info.This().As<Object>(), ctx.get());
        return enqueueWork(work);
    }
    ...
    Napi::Value StreamDecoder::seekAbsoluteAsync(const CallbackInfo& info) {
        ...
        AsyncDecoderWork* work = AsyncDecoderWork::forSeekAbsolute(info.This().As<Object>(), sample, ctx.get());
        return enqueueWork(work);
    }
    ...
    Napi::Value StreamDecoder::initOggStreamAsync(const CallbackInfo& info) {
        ...
        AsyncDecoderWork* work = AsyncDecoderWork::forInitOggStream(info.This().As<Object>(), ctx.get());
        return enqueueWork(work);
    }
    ...
    Napi::Value StreamDecoder::initFileAsync(const CallbackInfo& info) {
        ...
        AsyncDecoderWork* work = AsyncDecoderWork::forInitFile(info.This().As<Object>(), path, ctx.get());
        return enqueueWork(work);
    }
    ...
    Napi::Value StreamDecoder::initOggFileAsync(const CallbackInfo& info) {
        ...
        AsyncDecoderWork* work = AsyncDecoderWork::forInitOggFile(info.This().As<Object>(), path, ctx.get());
        return enqueueWork(work);
    }
    ...
    c_enum::DefineReturnType StreamDecoder::createStateEnum(const Napi::Env& env) {
        ...
        c_enum::defineValue(obj1, obj2, "SEARCH_FOR_METADATA", FLAC__STREAM_DECODER_SEARCH_FOR_METADATA);
        c_enum::defineValue(obj1, obj2, "READ_METADATA", FLAC__STREAM_DECODER_READ_METADATA);
        c_enum::defineValue(obj1, obj2, "SEARCH_FOR_FRAME_SYNC", FLAC__STREAM_DECODER_SEARCH_FOR_FRAME_SYNC);
        ...
        c_enum::defineValue(obj1, obj2, "MEMORY_ALLOCATION_ERROR", FLAC__STREAM_DECODER_MEMORY_ALLOCATION_ERROR);
    ...
    c_enum::DefineReturnType StreamDecoder::createInitStatusEnum(const Napi::Env& env) {
        ...
        c_enum::defineValue(obj1, obj2, "UNSUPPORTED_CONTAINER", FLAC__STREAM_DECODER_INIT_STATUS_UNSUPPORTED_CONTAINER);
        c_enum::defineValue(obj1, obj2, "INVALID_CALLBACKS", FLAC__STREAM_DECODER_INIT_STATUS_INVALID_CALLBACKS);
        c_enum::defineValue(obj1, obj2, "MEMORY_ALLOCATION_ERROR", FLAC__STREAM_DECODER_INIT_STATUS_MEMORY_ALLOCATION_ERROR);
        c_enum::defineValue(obj1, obj2, "ERROR_OPENING_FILE", FLAC__STREAM_DECODER_INIT_STATUS_ERROR_OPENING_FILE);
        c_enum::defineValue(obj1, obj2, "ALREADY_INITIALIZED", FLAC__STREAM_DECODER_INIT_STATUS_ALREADY_INITIALIZED);
        return std::make_tuple(obj1, obj2);
    }
    ...
    c_enum::DefineReturnType StreamDecoder::createReadStatusEnum(const Napi::Env& env) {
        ...
        c_enum::defineValue(obj1, obj2, "END_OF_STREAM", FLAC__STREAM_DECODER_READ_STATUS_END_OF_STREAM);
    ...
    c_enum::DefineReturnType StreamDecoder::createErrorStatusEnum(const Napi::Env& env) {
        ...
        c_enum::defineValue(obj1, obj2, "FRAME_CRC_MISMATCH", FLAC__STREAM_DECODER_ERROR_STATUS_FRAME_CRC_MISMATCH);
        c_enum::defineValue(obj1, obj2, "UNPARSEABLE_STREAM", FLAC__STREAM_DECODER_ERROR_STATUS_UNPARSEABLE_STREAM);
        return std::make_tuple(obj1, obj2);
    }
    ...
    constexpr FLAC__StreamDecoderReadStatus defaultReadCallbackReturnValue = FLAC__STREAM_DECODER_READ_STATUS_ABORT;
    FLAC__StreamDecoderReadStatus StreamDecoder::readCallback(const FLAC__StreamDecoder*, FLAC__byte buffer[], size_t* bytes, void* ptr) {
        ...
        try {
            ...
            auto ret = ctx->readCbk.MakeCallback(env.Global(), {jsBuffer}, *ctx->dec->asyncContext);
    ...
    FLAC__StreamDecoderSeekStatus defaultSeekCallbackReturnValue = FLAC__STREAM_DECODER_SEEK_STATUS_ERROR;
    FLAC__StreamDecoderSeekStatus StreamDecoder::seekCallback(const FLAC__StreamDecoder*, uint64_t offset, void* ptr) {
        auto ctx = (DecoderWorkContext*) ptr;
        if(ctx->dec->asyncExecutionProgress) {
        ...
        HandleScope scope(env);
        try {
            auto ret = ctx->seekCbk.MakeCallback(env.Global(), {numberToJs(env, offset)}, *ctx->dec->asyncContext);
    ...
    constexpr FLAC__StreamDecoderTellStatus defaultTellCallbackReturnValue = FLAC__STREAM_DECODER_TELL_STATUS_ERROR;
    FLAC__StreamDecoderTellStatus StreamDecoder::tellCallback(const FLAC__StreamDecoder*, uint64_t* offset, void* ptr) {
        auto ctx = (DecoderWorkContext*) ptr;
        if(ctx->dec->asyncExecutionProgress) {
        ...
        HandleScope scope(env);
        try {
            auto ret = ctx->tellCbk.MakeCallback(env.Global(), {numberToJs(env, *offset)}, *ctx->dec->asyncContext);
    ...
    constexpr FLAC__StreamDecoderLengthStatus defaultLengthCallbackReturnValue = FLAC__STREAM_DECODER_LENGTH_STATUS_ERROR;
    FLAC__StreamDecoderLengthStatus StreamDecoder::lengthCallback(const FLAC__StreamDecoder*, uint64_t* length, void* ptr) {
        auto ctx = (DecoderWorkContext*) ptr;
        if(ctx->dec->asyncExecutionProgress) {
        ...
        HandleScope scope(env);
        try {
            auto ret = ctx->lengthCbk.MakeCallback(env.Global(), {numberToJs(env, *length)}, *ctx->dec->asyncContext);
    ...
    FLAC__bool StreamDecoder::eofCallback(const FLAC__StreamDecoder*, void* ptr) {
        ...
        HandleScope scope(env);
        try {
            auto ret = ctx->eofCbk.MakeCallback(env.Global(), {}, *ctx->dec->asyncContext);
    ...
    constexpr FLAC__StreamDecoderWriteStatus defaultWriteCallbackReturnValue = FLAC__STREAM_DECODER_WRITE_STATUS_ABORT;
        ...
        try {
            ...
            for(uint32_t ch = 0; ch < channels; ch += 1) {
                auto buffer = pointer::wrap(
                    env,
                    const_cast<int32_t*>(samples[ch]),
                    frame->header.blocksize
                );
                buffers[ch] = buffer;
            }

            auto ret = ctx->writeCbk.MakeCallback(env.Global(), {frameToJs(env, frame), buffers}, *ctx->dec->asyncContext);
    ...
    void StreamDecoder::metadataCallback(const FLAC__StreamDecoder*, const FLAC__StreamMetadata* metadata, void* ptr) {
        auto ctx = (DecoderWorkContext*) ptr;
        if(ctx->dec->asyncExecutionProgress) {
        ...
        try {
            ...
            ctx->metadataCbk.MakeCallback(env.Global(), {jsMetadata}, *ctx->dec->asyncContext);
        } catch(const Error& error) {
            error.ThrowAsJavaScriptException();
        }
    }
    ...
    void StreamDecoder::errorCallback(const FLAC__StreamDecoder*, FLAC__StreamDecoderErrorStatus errorCode, void* ptr) {
        ...
        HandleScope scope(env);
        try {
            ctx->metadataCbk.MakeCallback(env.Global(), {numberToJs(env, errorCode)}, *ctx->dec->asyncContext);
        } catch(const Error& error) {
            error.ThrowAsJavaScriptException();
        }
    }
