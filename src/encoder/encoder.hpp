...
namespace flac_bindings {
  ...
  public:
    ...
    static AsyncEncoderWork*
      forInitFile(const StoreList&, const std::string& path, EncoderWorkContext* ctx);
    static AsyncEncoderWork*
      forInitOggFile(const StoreList&, const std::string& path, EncoderWorkContext* ctx);
  };
